...
namespace laboras_u223
{
    ...
    class Program
    {
        ...
        {               // pavadinimas, svoris, kaina, plotas
            ...
            Console.WriteLine("-------------------------------------------------------------------------------------------------");
            Console.WriteLine(bread1.Getvardas() + " | " + bread1.GetSvoris() + " | " + bread1.Getkaina() + " | " + bread1.Getplotas());
            Console.WriteLine(bread2.Getvardas() + " | " + bread2.GetSvoris() + " | " + bread3.Getkaina() + " | " + bread2.Getplotas());
            Console.WriteLine(bread3.Getvardas() + " | " + bread3.GetSvoris() + " | " + bread3.Getkaina() + " | " + bread3.Getplotas());
            Console.WriteLine(kepykla1.Getkepyklospav() + " | " + kepykla1.Getrusis1() + " | " + kepykla1.Getrusis2() + " | " + kepykla1.Getrusis3() + " | " +kepykla1.Getkiekduonos());
            Console.WriteLine("-------------------------------------------------------------------------------------------------");
            Console.WriteLine("Rezultatai : ");
            Console.WriteLine("-------------------------------------------------------------------------------------------------");
            Console.Write("Lengviausia Duona :  ");
            Console.WriteLine("Brangiausia Duona : ");
            Console.Write(L_Dpavadinimas + "   " );
            Console.WriteLine(B_Dpavadinimas);
            Console.WriteLine("-------------------------------------------------------------------------------------------------");
            Console.Write("Lentynos plotas 1 rūšies duonų: ");
            Console.Write("Lentynos plotas 2 rūšies duonų: ");
            Console.WriteLine("Lentynos plotas 3 rūšies duonų: ");
            Console.Write("      " + plotas1 + "m2                                ");
            Console.Write(plotas2 + "m2                               ");
